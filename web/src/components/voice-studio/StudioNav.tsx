import { Library, Mic2, Radio, Speech } from "lucide-react"
import { Link, useLocation } from "react-router-dom"

const items = [{ path: "/workshop", label: "音色工坊", icon: Mic2 }, { path: "/voices", label: "音色库", icon: Library }, { path: "/tts", label: "文字转语音", icon: Speech }, { path: "/live", label: "实时变声", icon: Radio }]
